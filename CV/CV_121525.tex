...
\begin{tabular}{@{}l @{\hspace{6ex}} l @{}}
    \textbf{Relevant Coursework:} & Topics in Economic History (ECON 229), Proofs \& Modern Mathematics (MATH 56), \\
...
\textit{\textbf{How Effective is In-Kind Food Aid? Evidence from USAID}} \\ (with Phil Hoxie and Vincent Smith) \hfill \textit{In progress} \smallskip\\
